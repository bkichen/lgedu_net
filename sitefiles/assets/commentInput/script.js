function loadComments(homeUrl, apiGetUrl, apiActionsAddUrl, apiActionsGoodUrl, apiActionsDeleteUrl, apiLogoutUrl, requestCount, isDelete, IsSubmit) {
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            list: function() {
                ...
                stlClient.get(apiGetUrl + '?requestCount=' + app.requestCount + '&requestOffset=' + app.requestOffset + '&isSubmit=' + app.isSubmit, null, function (err, data) {
                    app.isLoading = false;
                    if (!err) {
